...
>
    ...
    <div class="relative mx-auto flex min-h-full w-full max-w-4xl items-center justify-center">
        ...
        <div class="shrink-0 space-y-4 border-t border-slate-200 bg-white px-5 py-5 sm:px-8 sm:py-6">
            ...
            @if ($canGiveTestimonial)
                <button type="button"
                        wire:click="openTestimonialForm"
                        class="inline-flex w-full items-center justify-center gap-1.5 text-sm font-semibold text-rose-600 transition hover:text-rose-700">
