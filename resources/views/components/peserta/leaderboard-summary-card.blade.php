...
@if ($variant === 'compact')
    <div class="ui-card relative flex h-full flex-col overflow-hidden border-primary-200/60 bg-gradient-to-b from-white via-primary-50/20 to-indigo-50/30 shadow-lg shadow-primary-100/30">
        <div class="relative overflow-hidden border-b border-primary-100/80 bg-gradient-to-r from-primary-600 via-primary-600 to-indigo-600 px-4 py-3">
        ...
        <div class="flex flex-1 flex-col p-4">
            <div class="grid flex-1 grid-cols-3 gap-2">
                <a href="{{ route('peserta.leaderboard.index', ['tab' => 'score']) }}"
                   wire:navigate
                   class="flex flex-col justify-center rounded-xl bg-amber-50/80 px-2 py-2.5 text-center ring-1 ring-amber-100 transition hover:bg-amber-100/80">
                ...
                <a href="{{ route('peserta.leaderboard.index', ['tab' => 'duel']) }}"
                   wire:navigate
                   class="flex flex-col justify-center rounded-xl bg-rose-50/80 px-2 py-2.5 text-center ring-1 ring-rose-100 transition hover:bg-rose-100/80">
                ...
                <a href="{{ route('peserta.leaderboard.index', ['tab' => 'xp']) }}"
                   wire:navigate
                   class="flex flex-col justify-center rounded-xl bg-violet-50/80 px-2 py-2.5 text-center ring-1 ring-violet-100 transition hover:bg-violet-100/80">
