...
<section aria-labelledby="platform-features-heading" class="mb-8">
    ...
    <div class="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
        ...
        {{-- 4. Challenge a Friend (coming soon) --}}
        <div class="ui-card relative overflow-hidden border-dashed border-slate-200/90 bg-slate-50/50 p-4"
             aria-disabled="true">
            <div class="flex items-start gap-3">
                <div class="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-slate-200/80 text-slate-500">
                    <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                ...
                <div class="min-w-0 flex-1">
                    <div class="flex flex-wrap items-center gap-1.5">
                        <h3 class="text-sm font-bold text-slate-600">Challenge a Friend</h3>
                        <span class="ui-badge bg-slate-200/80 text-slate-600 text-[10px]">Segera Hadir</span>
                    </div>
                    <p class="mt-1 text-xs leading-relaxed text-slate-400">
                        Tantang teman dalam simulasi yang sama dan bandingkan skor secara langsung.
                    </p>
                    <p class="mt-2.5 text-xs font-medium text-slate-400">Sedang dalam pengembangan</p>
                </div>
            </div>
        </div>
    </div>
