...
@if (is_array($report) && ($report['errors'] ?? []) !== [])
    ...
    >
        ...
        <div
            ...
            class="relative flex max-h-[90vh] w-full max-w-5xl flex-col overflow-hidden rounded-2xl bg-white shadow-2xl shadow-slate-900/25"
        >
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div class="min-w-0 flex-1">
                        ...
                        <div class="mt-3 inline-flex items-center gap-2 rounded-full bg-white/80 px-3 py-1 text-xs font-semibold text-rose-700 ring-1 ring-rose-200">
                            ...
                            {{ $report['total'] ?? count($report['errors']) }} kesalahan ditemukan
                        </div>
                    </div>
                    <button
                        type="button"
            ...
            <div class="flex flex-col-reverse gap-2 border-t border-slate-100 bg-slate-50/80 px-6 py-4 sm:flex-row sm:justify-end">
                <button type="button" @click="open = false" class="ui-btn-secondary">
                    Tutup
                </button>
                <button
                    type="button"
