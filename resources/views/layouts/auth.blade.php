    ...
    <div class="flex min-h-screen">
        ...
        <div class="relative hidden w-1/2 overflow-hidden lg:flex lg:flex-col lg:justify-between">
            ...
            <div class="relative z-10 flex flex-col h-full justify-between p-12">
                ...
                <!-- Feature chips -->
                <div class="mt-8 grid w-full grid-cols-2 gap-2.5">
                    <div class="flex items-center gap-2 rounded-xl border border-primary-200/20 bg-white/10 px-3 py-2.5 text-xs font-medium text-primary-100 shadow-sm backdrop-blur-sm">
                        <span class="flex h-6 w-6 shrink-0 items-center justify-center rounded-lg bg-yellow-300/15">
                            <svg class="h-3.5 w-3.5 text-yellow-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <span class="whitespace-nowrap">Kunci Jawaban & Pembahasan</span>
                    </div>
                    <div class="flex items-center gap-2 rounded-xl border border-primary-200/20 bg-white/10 px-3 py-2.5 text-xs font-medium text-primary-100 shadow-sm backdrop-blur-sm">
                        <span class="flex h-6 w-6 shrink-0 items-center justify-center rounded-lg bg-sky-300/15">
                        ...
                        <span class="whitespace-nowrap">Waktu Ujian Real-Time</span>
                    </div>
                    <div class="flex items-center gap-2 rounded-xl border border-primary-200/20 bg-white/10 px-3 py-2.5 text-xs font-medium text-primary-100 shadow-sm backdrop-blur-sm">
                        <span class="flex h-6 w-6 shrink-0 items-center justify-center rounded-lg bg-pink-300/15">
                            <svg class="h-3.5 w-3.5 text-pink-200" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <span class="whitespace-nowrap">Simulasi Resmi</span>
                    </div>
                    <div class="flex items-center gap-2 rounded-xl border border-primary-200/20 bg-white/10 px-3 py-2.5 text-xs font-medium text-primary-100 shadow-sm backdrop-blur-sm">
                        <span class="flex h-6 w-6 shrink-0 items-center justify-center rounded-lg bg-indigo-300/15">
                            <svg class="h-3.5 w-3.5 text-indigo-200" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <span class="whitespace-nowrap">Evaluasi & Rapor Kesiapan CPNS Berbasis AI</span>
                    </div>
                </div>
            </div>
