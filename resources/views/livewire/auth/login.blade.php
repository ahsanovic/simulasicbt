<div class="space-y-5">
    ...
    <div>
        <label for="login" class="ui-label">Username atau NIP</label>
        <input id="login" type="text" wire:model="login" autocomplete="username" class="ui-input" placeholder="username atau NIP">
