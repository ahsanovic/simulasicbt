                        ...
                        <div class="min-w-0 flex-1">
                            ...
                            <div class="mt-4 flex flex-wrap gap-2">
                                <span class="ui-badge bg-slate-100 text-slate-700">
                                    <svg class="mr-1 inline h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0"/></svg>
