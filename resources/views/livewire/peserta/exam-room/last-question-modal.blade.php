@if ($showLastQuestionModal)
    <div
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="last-question-modal-title"
        x-data
        ...
        <div class="relative w-full max-w-md overflow-hidden rounded-3xl bg-white shadow-2xl shadow-slate-900/30">
            <div @class([
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h2 id="last-question-modal-title" class="text-lg font-bold tracking-tight">Soal Terakhir</h2>
            ...
            <div class="space-y-5 p-6 sm:p-8">
                @if ($this->unansweredCount === 0)
                    <div class="space-y-2 text-center">
                        ...
                        <p class="text-sm text-slate-600">
                            Anda berada di soal terakhir dan jawaban sudah tersimpan. Selesaikan ujian untuk melihat skor.
                        </p>
                    </div>
                @else
                    <div class="rounded-2xl border border-amber-200 bg-amber-50 px-4 py-4 text-center">
                        ...
                        <p class="mt-2 text-sm text-amber-900/80">
                            Yakin ingin menyelesaikan ujian sekarang?
                        </p>
                    </div>
                @endif
                ...
                <div class="flex flex-col gap-3 sm:flex-row-reverse">
                    ...
                    >
                        <span wire:loading.remove wire:target="submitExam">Selesai Ujian</span>
                        <span wire:loading wire:target="submitExam">Mengumpulkan...</span>
                    </button>
                    <button
                        type="button"
