                ...
                @foreach ($entries as $entry)
                    <li wire:key="lb-{{ $entry['user_id'] }}"
                        ...
                        <span @class([
                            ...
                            {{ $entry['name'] }}
                            @if ($entry['is_current'])
                                <span class="ml-0.5 inline-flex rounded-md bg-primary-200/60 px-1 py-px text-[9px] font-bold uppercase tracking-wide text-primary-800">Anda</span>
                            @endif
                        </span>
            ...
            @if ($currentUser)
                <div class="mx-2 mb-2 mt-1">
                    ...
                    <div class="flex items-center gap-2.5 rounded-xl bg-gradient-to-r from-primary-100/90 via-primary-50/60 to-indigo-50/40 px-2.5 py-2 ring-2 ring-primary-300/70 shadow-sm shadow-primary-100/50">
                        ...
                        <span class="min-w-0 flex-1 truncate text-[13px] font-bold leading-tight text-primary-900" title="{{ $currentUser['name'] }}">
                            {{ $currentUser['name'] }}
                            <span class="ml-0.5 inline-flex rounded-md bg-primary-200/60 px-1 py-px text-[9px] font-bold uppercase tracking-wide text-primary-800">Anda</span>
                        </span>
